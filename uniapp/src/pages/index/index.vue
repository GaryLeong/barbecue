  ...
  <view class="page">
    ...
    <view class="header">
      <view class="header-left">
        <image class="header-icon" src="/static/images/5.svg" mode="aspectFit" />
        <view class="header-info">
          <view class="table-no">
            <text class="table-text">当前桌号: B12</text>
            <image class="arrow-icon" src="/static/images/6.svg" mode="aspectFit" />
          </view>
          <text class="brand">Beijing BBQ</text>
        </view>
      </view>
      <view class="header-right">
        <image class="avatar" src="/static/images/7.svg" mode="aspectFit" />
      </view>
    </view>
    ...
    <scroll-view class="content" scroll-y :style="{ height: scrollHeight + 'px' }">
      ...
      <view class="banner">
        <swiper class="banner-swiper" indicator-dots autoplay circular>
          <swiper-item>
            <view class="banner-item">
              <image class="banner-img" src="/static/images/17.png" mode="aspectFill" />
        ...
        <view class="banner-dots">
          <image class="dot" src="/static/images/8.svg" mode="aspectFit" />
          <image class="dot" src="/static/images/9.svg" mode="aspectFit" />
          <image class="dot" src="/static/images/10.svg" mode="aspectFit" />
        </view>
      </view>
      ...
      <view class="section">
        <view class="section-header">
          ...
          <view class="section-more">
            <text>全部</text>
            <image class="more-icon" src="/static/images/11.svg" mode="aspectFit" />
          </view>
        </view>
        <view class="must-try-list">
          <!-- 大卡片 -->
          <view class="big-card">
            <image class="big-card-img" src="/static/images/20.png" mode="aspectFill" />
            <view class="big-card-info">
              <view class="hot-tag">
                <image class="fire-icon" src="/static/images/15.svg" mode="aspectFit" />
                <text>超人气</text>
              </view>
              ...
              <view class="big-card-bottom">
                ...
                <view class="add-btn">
                  <image class="add-icon" src="/static/images/16.svg" mode="aspectFit" />
                </view>
              </view>
            </view>
          </view>
          ...
          <view class="small-cards">
            <view class="small-card">
              <image class="small-card-img" src="/static/images/18.png" mode="aspectFill" />
              <text class="small-card-name">呼伦贝尔羊肉串</text>
              <view class="tag spicy">
                <image class="tag-icon" src="/static/images/12.svg" mode="aspectFit" />
                <text>微辣</text>
              </view>
              <view class="small-card-bottom">
                ...
                <view class="add-btn-gray">
                  <image class="add-icon" src="/static/images/13.svg" mode="aspectFit" />
                </view>
              </view>
            </view>
            <view class="small-card">
              <image class="small-card-img" src="/static/images/19.png" mode="aspectFill" />
              ...
              <view class="small-card-bottom">
                ...
                <view class="add-btn-gray">
                  <image class="add-icon" src="/static/images/14.svg" mode="aspectFit" />
                </view>
              </view>
            </view>
          </view>
      ...
      <view class="section">
        ...
        <scroll-view class="drinks-scroll" scroll-x>
          <view class="drinks-list">
            <view class="drink-card" v-for="(item, index) in drinks" :key="index">
              <view class="drink-img-wrap">
                <image class="drink-img" :src="item.img" mode="aspectFill" />
              </view>
      ...
      <view class="checkout-content">
        <view class="cart-info">
          <view class="cart-icon-wrap">
            <image class="cart-icon" src="/static/images/4.svg" mode="aspectFit" />
